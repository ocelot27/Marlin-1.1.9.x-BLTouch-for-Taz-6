...
//    #define LULZBOT_QUICKHOME
    ...
    #define LULZBOT_HOMING_FEEDRATE_XY            (50*60) // mm/m
    #define LULZBOT_HOMING_FEEDRATE_Z             (4*60)  // mm/m
...
// Only the TAZ 6 has a Z-homing button
    ...
    #define LULZBOT_Z_SAFE_HOMING
    #define LULZBOT_Z_SAFE_HOMING_X_POINT         20
    #define LULZBOT_Z_SAFE_HOMING_Y_POINT         255
    #define LULZBOT_Z_HOMING_HEIGHT               5
#else
    ...
    #define LULZBOT_BACKOFF_FEEDRATE 20
    #define LULZBOT_BACKOFF_DIST_XY  2
    #define LULZBOT_BACKOFF_DIST_Z   5
...
/*********************** AUTOLEVELING / BED PROBE *******************************/
    ...
    #define LULZBOT_LEFT_PROBE_BED_POSITION       20
    #define LULZBOT_RIGHT_PROBE_BED_POSITION     260
    #define LULZBOT_BACK_PROBE_BED_POSITION      255
    #define LULZBOT_FRONT_PROBE_BED_POSITION      20
#endif
...
#define LULZBOT_X_PROBE_OFFSET_FROM_EXTRUDER  -5
#define LULZBOT_Y_PROBE_OFFSET_FROM_EXTRUDER  -45
#define LULZBOT_Z_PROBE_OFFSET_RANGE_MIN      -2.5
#define LULZBOT_Z_PROBE_OFFSET_RANGE_MAX      5
#define LULZBOT_XY_PROBE_SPEED                8000
#define LULZBOT_Z_PROBE_SPEED_SLOW           (2*60)
#if defined(LULZBOT_USE_Z_BELT)
    #define LULZBOT_Z_PROBE_SPEED_FAST       (20*60)
#else
    #define LULZBOT_Z_PROBE_SPEED_FAST       (6*60)
#endif
#define LULZBOT_Z_CLEARANCE_DEPLOY_PROBE_WORKAROUND
#define LULZBOT_Z_CLEARANCE_DEPLOY_PROBE      3
...
#define LULZBOT_TEMP_SENSOR_0                 -1
...
// Hotend variants
    ...
    #define LULZBOT_DEFAULT_Kp 40
    #define LULZBOT_DEFAULT_Ki 1.5
    #define LULZBOT_DEFAULT_Kd 130
...
#elif defined(LULZBOT_IS_TAZ)
    #define LULZBOT_DEFAULT_XJERK                 10.0
    #define LULZBOT_DEFAULT_YJERK                 10.0
    #define LULZBOT_DEFAULT_ZJERK                 0.4
